document.addEventListener('DOMContentLoaded', function() {
    ...
    let chart = new OrgChart(document.getElementById("tree"), {
        ...
        nodeMenu: {
            add: {text: "Add New"},    // Option to add a new node.
            edit: {text: "Edit"},      // Option to edit the current node.
            remove: {text: "Remove"}   // Option to remove the current node.
        },
        ...
        editForm: {
            ...
            elements: [
                ...
                { type: 'textbox', label: 'Photo Url', binding: 'ImgUrl', btn: 'Upload' }, // Textbox for image URL with an upload button.
                { type: 'textbox', label: 'Name', binding: 'EmployeeName' },
    ...
    async function sendOrgChartData(actionType, data, nodeId = null) {
        ...
        formData.append('action', 'simple_orgchart_update'); // This is the WordPress AJAX action hook.
   ...
   chart.editUI.on('element-btn-click', function (sender, args) {
        OrgChart.fileUploadDialog(function (file) {
            ...
            fetch('/wp-admin/admin-ajax.php?action=upload_image_to_media', {
                method: 'POST',
                body: formData
            })
            .then(response => {
    ...
    if (initialData && initialData.length > 0) {
        ...
        chart.load([
            { id: "1", EmployeeName: "New Employee", Title: "Click to Edit", ImgUrl: "[https://cdn.balkan.app/shared/empty.jpg](https://cdn.balkan.app/shared/empty.jpg)" }
        ]);
    }
});
